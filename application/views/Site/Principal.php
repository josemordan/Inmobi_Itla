						   ...
						   <div>
                            ...
                            foreach ($Anuncio as $anuncio) {
                            	...
                            	echo <<<filas
                            	 ...
                            	 <ul class="list">
									<li>
									<img src= "base_url('{$anuncio->imagen}')" title="imagen" alt="" />
									...
									<button onclick="abrirVentana();" class="btn btn-default btn-sm right" style="margin-top: 20px"; >Mas Infomacion</button>
									</section>
									<div class="clearfix"></div>
									</li> 
...
filas;
						...
						var pagina="<html> <head> <title>omarlin</title></head><body> <h1>hola</h1></body></html>
