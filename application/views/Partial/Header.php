		...
		<div class="w3ls-header"><!--header-one--> 
			<div class="w3ls-header-right">
				<ul>
					...
					<li class="dropdown head-dpdn">
						<a href="<?php echo base_url('Login');?>" aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i>Mi Cuenta</a>
					</li>
					<li class="dropdown head-dpdn">
	...
	<!-- Large modal -->
		...
		<div class="container">
			<div class="agile-its-header">
				...
				<a class="post-w3layouts-ad" href="<?php echo base_url('Login')?>">Subir Anuncio</a>
				</div>
